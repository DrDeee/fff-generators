    ...
    <b-steps :has-navigation="false" destroy-on-hide>
      ...
      <b-step-item step="6" label="Download" clickable>
        <div class="columns">
          <div class="column">
            <div class="content">
              Hier kannst du deine Anmeldung als PDF herunterladen. Beachte,
              dass du alle Felder ausfüllen musst, um eine vollständige
          ...
          <div class="column">
            <preview :refresh="refresh" :data-url="dataUrl" />
          </div>
        </div>
      </b-step-item>
      <template #navigation>
...
import hilfsmittel from '~/data/versammlungsMittel'
...
export default class DemoanmeldungsGenerator extends Vue {
  ...
  get docDefinitions(): TDocumentDefinitions {
    ...
    return {
      ...
      content: [
        {
          text: 'Anmeldung einer Versammlung unter freiem Himmel \n nach § 14 Versammlungsgesetz',
          bold: true,
          fontSize: 18,
          alignment: 'center',
          margin: [0, 0, 0, 20],
